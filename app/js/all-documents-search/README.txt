...
- Don't use input placeholders or hardcoded values to label fields, because the text disappeara as soon as the field is focused. Instead, use the <label> element.
...
- The dropdown of filters are shown in 2 columns, each in their own <ul> element.
    ...
    *** Let me know if you don't have strong feelings about 2 <ul> elements, because it'd be easier for me and more semantic and accessible to group them in a single <ul> element and then use flexbox (recommended), CSS columns, or another style method to wrap the results into multiple columns.
